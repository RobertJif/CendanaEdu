  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li >
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_beranda')?>">
            <i class="fa fa-dashboard"></i> <span>Beranda</span>
          </a>
        </li>
         <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_profil')?>">
            <i class="fa fa-pencil"></i>
      <span>Profil</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_nilai')?>">
      ...
      <span>Nilai</span>
        ...
        <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_prestasi')?>">
            <i class="fa fa-book"></i>
      <span>Prestasi</span>
          </a>
        </li>
        ...
        <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_ekskul')?>">
            <i class="fa fa-book"></i>
      <span>Ekstrakulikuler</span>
          </a>
        </li>
         <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_peminjamanbuku')?>">
            <i class="fa fa-book"></i>
      <span>Peminjaman Buku</span>
          </a>
        </li>
                 <li>
          <a href="<?php echo site_url('Siswa_controller/Tampilsiswa_pelanggaran')?>">
            <i class="fa fa-book"></i>
