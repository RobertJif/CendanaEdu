      ...
      <div class="row" style="margin-left:250px;margin-right:-250px">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <center>  <h3 class="box-title"> Form Tambah Tahun Semester</h3></center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            
               <form role="form" action="<?php echo site_url('Admin_controller/Tampilkur_tahunsemester_formtambahtahunsemestercek')?>" method="POST" name="myForm" onSubmit="return validateForm()">
              <div class="box-body">
