...
public class LoginActivity extends AppCompatActivity {
    ...
    private void login() throws IOException, JSONException {
        ...
        map.put(AndyConstants.Params.NISN, etusername.getText().toString());
        map.put(AndyConstants.Params.PASSWORD, etpassword.getText().toString());
        Nilai nil = new Nilai();
        nil.setIduser(etpassword.getText().toString());
        ...
        switch (task) {
            case LoginTask:
                if (parseContent.isSuccess(response)) {
                    ...
                    String app_server_url = AndyConstants.ServiceType.BASE_URL+"fcm_insert.php";
                    ...
                    })
                    {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            params.put("nisn",preferenceHelper.getNISN());
                    ...
                    Intent intent = new Intent(LoginActivity.this,MainActivityDrawerPengumuman.class);
